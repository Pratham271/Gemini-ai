...
const Output = ({data,loading,copyToClipboard}) => {
  return (
    <div className="group flex flex-1 justify-center gap-2">
    {loading? 
    <div role="status">
   ...
   <div className="flex-1">
      <div className="prose dark:prose-invert prose-p:leading-relaxed prose-pre:p-0 break-words">
        <p className="mb-2 last:mb-0 text-base" style={{whiteSpace: 'pre'}}>  
        {data}
        </p>
      </div>
    </div>
